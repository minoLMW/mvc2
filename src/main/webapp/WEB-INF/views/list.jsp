...
<html>
  ...
  <body>
    ...
    <div class="container">
      <!-- 검색 폼 -->
      <form method="get" action="list.board" style="margin-bottom: 20px; display: flex; gap: 10px; align-items: center;">
        <select name="searchField">
          ...
          <option value="user_id" ${param.searchField == 'user_id' ? 'selected' : ''}>작성자</option>
        </select>
        <input type="text" name="searchWord" placeholder="검색어 입력" value="${param.searchWord}" />
      ...
      <div class="pagination">
        ...
        <c:forEach begin="1" end="${totalPages}" var="page">
          <c:choose>
            ...
            <c:otherwise>
              <a href="list.board?page=${page}&searchField=${param.searchField}&searchWord=${param.searchWord}">
                  ${page}
              </a>
            </c:otherwise>
          </c:choose>
